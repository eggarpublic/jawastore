    ...
    <section className="relative w-full h-screen overflow-hidden bg-[#1A1A1A]">
      ...
      <AnimatePresence mode="wait">
        <motion.div
          ...
          <Image
            src={current.image || "/background/2.webp"}
            alt="background"
            fill
      ...
      <div className="relative z-20 flex flex-col h-full px-6">
        ...
        <div className="flex flex-col md:flex-row justify-between h-full w-full">
          ...
          <div className="flex flex-col justify-center h-full max-w-3xl ml-8 md:ml-16 lg:ml-24">
            ...
            <motion.div
              ...
              transition={{ duration: 0.8 }}
              className="mb-2">
              <h2 className="text-[#00C8D7] font-bold text-lg md:text-xl tracking-widest">
                JAWA STORE EXCLUSIVE
              </h2>
            </motion.div>
            ...
            <motion.div
              ...
              className="h-1 bg-gradient-to-r from-[#D9A154] to-[#A8743D] my-4"></motion.div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-8">
              <motion.button
                whileHover={{
                  ...
                  boxShadow:
                    selected === "akun"
                      ? "0 0 15px rgba(217,161,84,0.8)"
                      : "0 0 15px rgba(0,200,215,0.5)",
                }}
                whileTap={{ scale: 0.97 }}
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
            ...
            <motion.a
              ...
              <span
                ...
                ${
                  selected === "akun" ? "bg-[#00C8D7]" : "bg-[#D9A154]"
                }`}></span>
            </motion.a>
          </div>
              ...
              <motion.div
                ...
                <motion.div
                  ...
                  <Image
                    ...
                    alt={
                      selected === "akun" ? "Premium Account" : "Custom Website"
                    }
                    fill
        ...
        <div className="absolute top-10 right-10 flex items-center">
          ...
          <div className="text-[#00C8D7] text-xs font-mono">
            SECURE CONNECTION
          </div>
        </div>
