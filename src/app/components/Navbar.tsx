  ...
  return (
    <motion.nav
      ...
      <div className="max-w-7xl mx-auto px-4 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-3 group">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[10px] text-[#00C8D7] -mt-1 opacity-80">
              PREMIUM SERVICES
            </span>
          </div>
        </Link>
      ...
      <motion.div
        ...
        className="h-0.5 bg-gradient-to-r from-[#00C8D7] via-[#D9A154] to-[#A8743D] origin-left md:hidden"></motion.div>
    </motion.nav>
  );
}
