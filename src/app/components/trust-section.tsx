...
const customerPhotos = [
  {
    id: 1,
    name: "Andi",
    photo: "/gambar/konoha.png",
    service: "Netflix",
    quote: "Lancar jaya, sudah 6 bulan pakai!",
    stars: 5,
  },
  {
    id: 2,
    name: "Budi",
    photo: "/gambar/gaminghub.png",
    service: "Website UMKM",
    quote: "Omset naik 3x sejak punya website",
    stars: 5,
  },
  {
    id: 3,
    name: "Citra",
    photo: "/gambar/roadguard.png",
    service: "Canva Pro",
    quote: "Desain jadi lebih profesional",
    stars: 4,
  },
];
